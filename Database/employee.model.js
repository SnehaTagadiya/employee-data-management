...
Employee.getEmployeeByName = (first_name, result) => {
    dbConn.query('SELECT * FROM employee WHERE first_name=?', first_name, (err, res) => {
        if (err) {
...
Employee.updateEmployee = (id, employeeReqData, result) => {
    dbConn.query("UPDATE employee SET first_name=?,last_name=?,email=?,phone=?,salary=? WHERE id = ?", [employeeReqData.first_name, employeeReqData.last_name, employeeReqData.email, employeeReqData.phone, employeeReqData.salary, id], (err, res) => {
        if (err) {
